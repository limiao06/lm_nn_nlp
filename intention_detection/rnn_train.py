...
tf.flags.DEFINE_string("rnn_model", "lstm", "rnn, gru or lstm(default: 'lstm')")
tf.flags.DEFINE_integer("num_layerss", 1, "Number of layers of rnn(default: 1)")
...
tf.flags.DEFINE_integer("max_gradient_norm", 5, "Max gradient clip")
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        with tf.device('/gpu:0'):
            ...
            acc_summary = tf.scalar_summary("accuracy", rnn.accuracy)
