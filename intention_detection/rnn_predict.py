...
if __name__ == '__main__':
    rnn_predictor = RNNPredict(FLAGS.model_dir, FLAGS.model_point)
    print rnn_predictor.predict_prob(u'刘德华')
    print rnn_predictor.predict_prob(u'夜间 天气 怎么 样')
    print rnn_predictor.predict_prob(u'真 的 没 心情 啊')
